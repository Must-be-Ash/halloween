...
const filterConfigs = {
  ...
  space: {
    prompt:
      "Create a HYPER-REALISTIC, PHOTOGRAPHIC transformation with futuristic space mission aesthetics. ULTRA-REALISTIC DETAILS: For PEOPLE: Transform into astronauts wearing photorealistic, have their face clearly visible (any glass or helmet covering their face should be see-through and transparent) white space suits with sleek Coinbase-branded design elements - realistic Coinbase logo patches on chest and shoulders, authentic blue accent stripes following real spacesuit construction, realistic gold-tinted helmet visor reflecting Earth and stars with person's face clearly visible through transparent faceplate, maintain exact facial features with realistic helmet lighting effects on face, genuine life support backpack with modern tubes and connections, accurate space gloves with realistic material textures, authentic Coinbase mission patches integrated naturally into suit design. Add realistic space suit physics with proper pressurization appearance, authentic fabric textures with modern technical materials. For LANDSCAPES: Transform into photorealistic space station interior with futuristic control panels, realistic floating objects in zero gravity, genuine Earth view through windows showing accurate continental geography, realistic LED lighting systems with blue Coinbase accent lighting. Or create realistic lunar surface with accurate regolith texture, realistic Earth rising over lunar horizon with correct astronomical positioning. For OBJECTS: Transform into futuristic space equipment with realistic materials - titanium, aluminum, carbon fiber textures, modern interfaces with Coinbase branding subtly integrated. CRITICAL: Must look like actual modern space mission photography with Coinbase branding naturally integrated. Maintain exact facial features visible through helmet visor, use authentic space aesthetics with Coinbase blue accents, realistic zero-gravity physics, accurate astronomical lighting, and genuine space equipment details. Perfect space documentary photography quality with natural Coinbase brand integration.",
  },
  medieval: {
    prompt:
